...
## Message [2026-04-28] — Progress saved 중복 + 메시지 불명확 + 변화 논문 목록
...
## Message [2026-04-29] — 2020年被误选/2021年未选的疑惑
...
## Message [2026-04-30] — 缓存体系解释 + year-based fetch 丢失条目修复
...
## Message [2026-05-01] — 缓存字段确认 + cites_id null bug 修复
...
## Message [2026-05-01] — 输出文件作为跨运行状态来源
