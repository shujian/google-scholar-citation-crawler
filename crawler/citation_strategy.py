...
def build_citation_count_summary(citations, scholar_total=None, probed_year_counts=None,
    ...
    if year_diags:
        ...
        # Year-mode seen_total comes from per-year sums only;
        # unyeared citations are intentionally excluded (they are
        # dropped during year-based fetch to keep per-year diffs clean).
